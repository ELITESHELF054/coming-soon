...
function displayContactInfo() {
  var contactInfo = `<i class="fa-solid fa-x close-icon" fa-2x onclick="closeDisplay()"></i>
  <br><div class="display-text">Email us at: eliteshelf054@gmail.com 
  <br>Phone Number: +234 817 849 5978 
  <br><br>
  <p>"A reader lives a thousand lives before he dies... The man who never reads lives only one." <br>~ George R.R. Martin</p>
   ...
   <div>
    ...
    <a href="https://twitter.com/elite_shelf?t=WQUEaAKjreWCaiivP2CJDA&s=09"><img src="images/twiter.png" alt="Twiter Logo"></a> 
    ...
    <a href="https://www.linkedin.com/in/elite-shelf"><img src="images/LinkedIn.png" alt="LinkedIn Logo" id="linkedin-logo"></a> 
  ...
  diplay.classList.remove("active");

  //This removes a class of active from the popup div to make it vissible. It happens when the "Contact Us" button is clicked.
}
